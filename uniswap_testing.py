...
def get_uniswap_price_v2(contract, token_a,token_b,amount=1):
...
# from uni_token_analysis import tokens6
def reserve(token_a,token_b):
    pair_address = fact_contr.functions.getPair(token_a, token_b).call()

    pair_contract=W3.eth.contract(address=pair_address, abi=uniswap_pair_abi)
    x = pair_contract.functions.getReserves().call()
    return x

# print(reserve(tokens6['UNI'], tokens6['AAVE']))

# print(get_uniswap_price_v2(None, tokens6['WETH'], tokens6['USDC'], 1))
# def main():
