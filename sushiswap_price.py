030842FC67cE582a6aFa3CCaB83': 18, '0x1F573D6Fb3F13d689FF844B4cE37794d79a7FF1C': 18, '0xBA11D00c5f74255f56a5E366F4F77f5A186d7f55': 18, '0x320623b8E4fF03373931769A31Fc52A4E78B5d70': 18, '0x607F4C5BB672230e8672085532f7e901544a7375': 9, '0x967da4048cD07aB37855c090aAF366e4ce1b9F48': 18, '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48': 6, '0x9f8F72aA9304c8B593d555F12eF6589cC3A579A2': 18, '0xc944E90C64B2c07662A292be6244BDf05Cda44a7': 18, '0xD533a949740bb3306d119CC777fa900bA034cd52': 18, '0x111111111117dC0aa78b770fA6A738034120C302': 18, '0xba100000625a3754423978a60c9317c58a424e3D': 18, '0x408e41876cCCDC0F92210600ef50372656052a38': 18, '0xBBbbCA6A901c926F240b89EacB641d8Aec7AEafD': 18, '0xd26114cd6EE289AccF82350c8d8487fedB8A0C07': 18, '0xdd974D5C2e2928deA5F71b9825b8b646686BD200': 18, '0x3E9BC21C9b189C09dF3eF1B824798658d5011937': 18, '0x0b38210ea11411557c13457D4dA7dC6ea731B88a': 18, '0xDDB3422497E61e13543BeA06989C0789117555c5': 18, '0x0F5D2fB29fb7d3CFeE444a200298f468908cC942': 18, '0x491604c0FDF08347Dd1fa4Ee062a822A5DD06B5D': 18, '0x57B946008913B82E4dF85f501cbAeD910e58D26C': 18, '0x476c5E26a75bd202a9683ffD34359C0CC15be0fF': 6}
...
def get_sushiswap_price_v2(contract, token_a,token_b,amount=1):
        token_a=Web3.to_checksum_address(token_a)
        token_b=Web3.to_checksum_address(token_b)
        with open('sushirouter.json') as f:
            sushi_router_abi = (json.load(f))['result']
        # print(pair_address)
        ...
        if not pair_address=="0x0000000000000000000000000000000000000000":
            ...
            # print('ddd')
            # Function to fetch reserves and calculate price
            router_contract = W3.eth.contract(address=sushiswap_router_address, abi=sushi_router_abi)
            # try:
            decimal_a = decimal_dict4[token_a]
            decimal_b = decimal_dict4[token_b]
            prices = router_contract.functions.getAmountsOut(amount*int(10**decimal_a),[token_a,token_b]).call()
            # print("these are the price",prices)

            # def fetch_price(pair_contract):
            #     reserves = pair_contract.functions.getReserves().call()
            #     reserve0, reserve1, _ = reserves
            #     raw_price = reserve1 / reserve0  # Assuming token0 is the base and token1 is the quote
            #     return raw_price

            return (prices[1] / (10 ** decimal_b))
...
# from uni_token_analysis import tokens6
# print(get_sushiswap_price_v2(None, tokens6['WETH'], tokens6['AAVE'], 1))
...
#                             print(sCoin, vCoin)
#                             buy_price, buy_path = get_uniswap_price_v2(
#
#                                 token_a=tokens3[vCoin.upper()],
#                                 token_b=tokens3[sCoin.upper()],
#                                 contract= None,
#                                 amount=1)
#                             print(buy_price, buy_path)
#
# for token in tokens6.values():
#     try:
#         decimal_arr[token]=get_token_decimal(token)
#     except:
# #         continue
# print(len(decimal_arr))
# print(len(tokens6))
# print(get_uniswap_price_v2(None, '0x7Fc66500c84A76Ad7e9c93437bFc5Ac33E2DDaE9', '0x1f9840a85d5aF5bf1D1762F925BDADdC4201F984', 1))
